...
const CoverPhoto = () => {
  ...
  function handleCoverChange(e) {
    ...
    const { valid, message } = validateImage(cover);
    ...
    dispatch(changeCoverPicThunk(cover));
  }
  ...
  return (
    <>
      <div className="relative border border-gray-300 border-t-0 bg-linear-to-b from-zinc-300 to-zinc-100 mb-1 w-full h-35 rounded-b-md overflow-clip">
        {<img src={coverLink} alt="" className="w-full" />}
